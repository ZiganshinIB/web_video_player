...
Текущий проект ялется web-страничкой и может использоваться как HTML/CSS/JS шаблоном видеоплейра

Для запуска проекта необходимо:
* браузер (поддерживающий HTLM5)

Что бы открыть и посмотреть web-страницу, откройте `index.html` в браузере 

## Описание 
* Основные стили и разметки web-страницы описаны в  `index.html`
...
* в папке  `./favicon/`  Хранится иконка web-страницы
